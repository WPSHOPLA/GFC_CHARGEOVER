				...
				<header class="header">
					<div class="clearfix">
						...
						<div class="col-sm-8 hidden-xs">
							...
							<div class="col-sm-8 hidden-xs">
								<div class="comb-search input-group">
									<input name="keyword" class="awesomplete" type="text" id="ajax" list="json-datalist" value="<?php echo htmlspecialchars($filter_keyword, ENT_QUOTES, 'UTF-8'); ?>" placeholder="Enter your keyword">
									
									<!--<datalist id="json-datalist"></datalist>-->
									<span class="search-button input-group-btn">
										<button class="submit-comb-search" value="submit" type="submit" name="question_search">&nbsp;&nbsp;&nbsp;&nbsp;Search</button>
									</span>
								</div>
							</div>
						...
						<div class="col-xs-8 col-sm-10">
							<div class="row user-navigation ng-scope">							
								<a href="<?php echo 'http://www.gofetchcode.com'?>" class="btn btn-transparent btn-rounded">Home</a>
								<a href="<?php echo BASE_URL . 'login.php'; ?>" class="btn btn-transparent btn-rounded">Login</a>
								<a href="<?php echo BASE_URL . 'register.php'; ?>" class="btn btn-transparent btn-rounded">Sign Up</a>
							</div>
						</div>
						<?php } else { ?>
						...
						<div class="nav-bar">
							...
							<ul class="list-unstyle">
								<li>
									<a onclick="$(this).next('ul').toggleClass('collapse');"><i class="fa fa-question-circle" aria-hidden="true"></i>&nbsp;&nbsp;Questions<span class="caret"></span></a>
									<ul class="list-unstyle cbc-chapters-list collapse">
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'search.php'; ?>">Search</a></li>
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'search.php?bookmarks=true'; ?>">Bookmarks</a></li>
										<?php if(isStaff()) { ?>
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'question_list.php'; ?>">Frequent Questions</a></li>
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'question_add.php'; ?>">Create a Question</a></li>
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'question_add_bulk.php'; ?>">Upload Questions CSV</a></li>
										<?php } ?>
									</ul>
									<?php if(isStaff()) { ?>
									...
									<?php } ?>
									<?php if(isStaff()) { ?>
									<a onclick="$(this).next('ul').toggleClass('collapse');"><i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;&nbsp;Logs<span class="caret"></span></a>
									<ul class="list-unstyle cbc-chapters-list collapse">
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'log_search.php'; ?>">Searches</a></li>
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'log_user.php'; ?>">User Log</a></li>
									</ul>
									<?php } ?>
									<a onclick="$(this).next('ul').toggleClass('collapse');"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;Account<span class="caret"></span></a>
									<ul class="list-unstyle cbc-chapters-list collapse">
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'account_settings.php'; ?>">Account Settings</a></li>
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'account_billing.php'; ?>">Billing</a></li>
										<?php if(true || isSubscribed()) { ?>
										<li class="ng-scope"><a href="<?php echo BASE_URL . 'account_billing.php?action=cancel_subscription'; ?>">Cancel Subscription</a></li>
										<?php } ?>
